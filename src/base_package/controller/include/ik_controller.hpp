...
#include "ik_controller_parameters.hpp" // auto generated by generate_parameter_library

// #include "drake_calculations.hpp"
...
protected:
  ...
  // DifferentialInverseKinematicsCalculator calculator_;

  MultibodyPlant<double> _plant;
  std::unique_ptr<Context<double>> _plantContextPointer;
  std::unique_ptr<Eigen::Matrix3Xd> _jacobian;
